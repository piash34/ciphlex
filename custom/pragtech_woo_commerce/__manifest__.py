{
    'name': "Ciphlex WooCommerce Connector",
    'version': '16.0.1.1.24',
    'category': 'Services',
    'author': 'Pragmatic TechSoft Pvt Ltd.',
    'website': 'www.pragtech.co.in',
    'summary': 'Ciphlex Woocommerce connector Woo Commerce import products export products import customers export customers import sales order export sales orders import tags export tags sync data word press wordpress connector woocommerce connector shopify',
    'description': """
        WooCommerce Connector
        ====================
        Ciphlex Woocommerce connector is used to import customers, products, sale-order from woocommerce to Ciphlex.
        This module has following features
        ----------------------------------
            1] Import/Export customer into Ciphlex/WooCommerce
            2] Import/Export product into Ciphlex/WooCommerce
            3] Import/Export product category into Ciphlex/WooCommerce
            4] Import/Export product attribute, values into Ciphlex/WooCommerce
            5] Import/Export product tags into Ciphlex/WooCommerce
            6] Import/Export sale-order into Ciphlex/WooCommerce
            7] Import/Export taxes into Ciphlex/WooCommerce
    ...
    'live_test_url': 'http://www.pragtech.co.in/company/proposal-form.html?id=103&name=oiphlex-woocomerce-connector',
    'currency': 'USD',
    'price': 0.0,  # 271
    'license': 'OPL-1',
    'active': False,
