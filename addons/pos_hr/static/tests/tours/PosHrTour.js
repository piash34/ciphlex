odoo.define('point_of_sale.tour.PosHr', function (require) {
    ...
    SelectionPopup.check.hasSelectionItem('Zeph Consultant');
    ...
    SelectionPopup.do.clickItem('Zeph Consultant');
    PosHr.check.cashierNameIs('Zeph Consultant');
    ...
    Chrome.do.clickTicketButton();
    TicketScreen.check.nthRowContains(4, 'Zeph Consultant');
