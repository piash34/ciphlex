odoo.define('website.tour.form_editor', function (require) {
    ...
    wTourUtils.registerWebsitePreviewTour("website_form_editor_tour", {
        ...
        },
        {
            ...
            trigger: 'iframe .s_website_form_field:eq(0) input[value="John Smith"]:propValue("Zeph Consultant")',
        },
        {
            content: 'Verify that phone field is still auto-fillable',
            trigger: 'iframe .s_website_form_field input[data-fill-with="phone"]:propValue("+234-814-990-6672")',
        },
