...
class TestHrEmployee(TestHrCommon):
    ...
    def test_employee_resource(self):
        ...
        employee_form.name = 'Henry Igbokwe'
        employee_form.work_email = 'henry@example.com'
    ...
    def test_employee_from_user(self):
        ...
        employee = employee_form.save()
        self.assertEqual(employee.name, 'Henry Igbokwe')
        ...
        user_1, user_2, user_3 = self.env['res.users'].create([
            {
                'name': 'Test User',
                'login': 'test_user',
                'email': 'test_user@ciphlex.com',
            },
            {
                'name': 'Test User 2',
                'login': 'test_user_2',
                'email': 'test_user_2@ciphlex.com',
                'create_employee': True,
            },
            {
                'name': 'Test User 3',
                'login': 'test_user_3',
                'email': 'test_user_3@ciphlex.com',
