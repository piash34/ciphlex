...
insertRecords('res.users', [
    { display_name: "Your Company, Zeph Consultant", id: TEST_USER_IDS.currentUserId, name: "Zeph Consultant", partner_id: TEST_USER_IDS.currentPartnerId, },
...
insertRecords('res.partner', [
    ...
    { display_name: "Your Company, Zeph Consultant", id: TEST_USER_IDS.currentPartnerId, name: "Zeph Consultant", },
    { active: false, display_name: "CiphlexAi", id: TEST_USER_IDS.partnerRootId, name: "CiphlexAi" },
]);
