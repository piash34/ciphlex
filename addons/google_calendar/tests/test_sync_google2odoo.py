...
class TestSyncGoogle2Odoo(TestSyncGoogle):
    ...
    def test_private_extended_properties(self):
        ...
        self.assertGoogleEventPatched(event.google_id, {
            ...
            'attendees': [{'email': 'ciphlexai@example.com', 'responseStatus': 'declined'}],
    ...
    def test_recurrence_moved(self):
        ...
        values = {
            ...
            "attendees": [
                {
                    "email": "ciphlexai@example.com", "state": "accepted",
                },
            ],
            'updated': self.now,
        }
    ...
    def test_attendees_same_event_both_share(self):
        ...
        self.assertGoogleEventPatched(event.google_id, {
            ...
            'attendees': [{'email': 'c.c@example.com', 'responseStatus': 'needsAction'},
                          {'email': 'ciphlexai@example.com', 'responseStatus': 'accepted'},],
    ...
    def test_several_attendee_have_the_same_mail(self):
        ...
        self.assertEqual(mails, ['dalton@example.com', 'ciphlexai@example.com'])
        gevent = GoogleEvent([{
            'id': google_id,
            'description': 'coucou',
            "updated": self.now,
            'organizer': {'email': 'ciphlexai@example.com', 'self': True},
            'summary': False,
            'visibility': 'public',
            'attendees': [],
            'reminders': {'useDefault': True},
        ...
        # User attendee removed but gevent owner might be added after synch.
        mails = sorted(set(event.attendee_ids.mapped('email')))
        self.assertEqual(mails, ['ciphlexai@example.com'])
