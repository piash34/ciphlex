...
class CrmLead(models.Model):
    ...
    def _populate_factories(self):
        ...
        country_be, country_us, country_in, country_ng = self.env.ref('base.be'), self.env.ref('base.us'), self.env.ref(
            'base.in'), self.env.ref('base.ng')
        phones_per_country = {
            ...
            country_ng.id: [False, '+2348023589421', '+2349036598752', '+2348145698723'],
