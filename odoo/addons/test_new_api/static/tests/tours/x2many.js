odoo.define('web.test.x2many', function (require) {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////
    {
        ...
        trigger: 'tr:has(td:containsExact(Zeph Consultant)) .o_list_record_selector input[type="checkbox"]'
    }, {
        content: "save selected participants",
        trigger: '.o_select_button',
        extra_trigger: 'tr:has(td:containsExact(Zeph Consultant)) .o_list_record_selector input[type="checkbox"]:propChecked',
    }, ...tour.stepUtils.saveForm({
        content: "save discussion",
        extra_trigger: '.o_field_widget[name=participants] .o_data_cell:containsExact(Zeph Consultant)',
    }), { // add message a
        ...
        trigger: '.o_field_widget[name=messages] .o_field_x2many_list_row_add a',
        extra_trigger: '.o_field_widget[name="message_concat"] textarea:propValue([test] Zeph Consultant:a)',
    }, {
        ...
        content: "insert content",
        trigger: '.o_field_widget[name=name] input',
        extra_trigger: '.o_field_widget[name="message_concat"] textarea:propValue([test] Zeph Consultant:a\n[test] Zeph Consultant:b)',
        run: 'text test_trigger',
    }, {
        content: "check onchange",
        trigger: '.o_field_widget[name="message_concat"] textarea:propValue([test_trigger] Zeph Consultant:a\n[test_trigger] Zeph Consultant:b)',
        run: function () {},
    }, { // change message b
        ...
        trigger: '.o_field_widget[name=messages] .o_field_x2many_list_row_add a',
        extra_trigger: '.o_field_widget[name="message_concat"] textarea:propValue([test_trigger] Zeph Consultant:a\n[test_trigger] Zeph Consultant:bbb)',
    }, {
        content: "insert body",
        trigger: '.o_field_widget[name="body"] textarea',
        run: 'text c',
        ...
        trigger: 'tr:has(td:containsExact(Emeka Onye)) .o_list_record_selector input[type="checkbox"]',
    }, {
        content: "save selected participants",
        trigger: '.o_select_button',
        extra_trigger: 'tr:has(td:containsExact(Emeka Onye)) .o_list_record_selector input[type="checkbox"]:propChecked',
    }, { // save
        content: "save discussion",
        ...
        trigger: '.o_content:has(.o_field_widget[name=messages] tr:has(td:containsExact(bbb)):has(td:containsExact([test_trigger] Zeph Consultant)))',
        run: function () {}, // it's a check
    }, {
        content: "go to tab 3",
        trigger: '.o_notebook_headers .nav-item a:contains(Participants)',
        ...
        trigger: '.o_field_widget[name="author"] .o-autocomplete--dropdown-menu li:contains(Emeka Onye)',
    }, {
        content: "test one2many's line onchange after many2one",
        trigger: '.o_field_widget[name=name]:contains([test_trigger] Emeka Onye)',
        run: function () {}, // it's a check
    }, {
        content: "test one2many field not triggered onchange",
        trigger: '.o_field_widget[name="message_concat"] textarea:propValueContains([test_trigger] Zeph Consultant:e)',
        in_modal: false,
        ...
        trigger: '.o_field_widget[name=messages] .o_data_cell:contains([test_trigger] Emeka Onye)',
        run: function () {}, // it's a check
    }, {
        content: "test one2many triggered the onchange on save",
        trigger: '.o_field_widget[name="message_concat"] textarea:propValueContains([test_trigger] Emeka Onye:e)',
        run: function () {}, // don't change texarea content
    }, { // remove
        content: "remove b",
        ...
        trigger: '.o_content:has(.o_field_widget[name=messages] tbody tr:has(td:containsExact([test_trigger] Zeph Consultant)):has(td:containsExact(aaa)))',
        run: function () {}, // it's a check
    }, {
        ...
        trigger: '.o_field_widget[name="message_concat"] textarea:propValueContains([test_trigger] Zeph Consultant:aaa\n[test_trigger] Zeph Consultant:c\n[test_trigger] Zeph Consultant:d\n[test_trigger] Emeka Onye:ddd)',
        run: function () {}, // don't change texarea content
    }, {
...

    {
        ...
        content: "test one2many's line onchange after many2one",
        trigger: '.o_field_widget[name=messages] td:contains([test_trigger2] Emeka Onye)',
        run: function () {}, // don't blur the many2one
    }, {
        content: "change text value",
        trigger: '.o_field_widget[name="body"] textarea',
        ...
        trigger: '.o_field_widget[name="message_concat"] textarea:propValueContains([test_trigger2] Emeka Onye:ccccc)',
        run: function () {}, // don't change texarea content
    }, {
        content: "click outside to trigger one2many onchange",
        ...
        trigger: '.o_content:not(:has(.o_field_widget[name="message_concat"] textarea:propValueContains(Zeph Consultant:d)))',
        run: function () {},
        ...
        trigger: '.o_field_widget[name=message_concat] textarea:propValueContains([test_trigger2] Zeph Consultant:aaa\n[test_trigger2] Emeka Onye:ccccc)',
        run: function () {}, // don't change texarea content
    }, {
        ...
        trigger: '.o_field_widget[name="message_concat"] textarea:propValueContains([test_trigger2] Zeph Consultant:aaa\n[test_trigger2] Emeka Onye:ccccc\n[test_trigger2] Zeph Consultant:eee)',
        run: function () {}, // it's a check
    }, {
